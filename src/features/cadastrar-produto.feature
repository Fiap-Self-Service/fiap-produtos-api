...
Cenário: Cadastro de produto com nome já cadastrado
  Dado que o produto fornece um nome já cadastrado
  Quando o produto solicita o cadastro
  Então uma exceção informando que o nome já existe deve ser lançada
...
Cenário: Cadastro de produto com nome inválido
  Dado que o produto fornece um nome inválido
  Quando o produto solicita o cadastro
